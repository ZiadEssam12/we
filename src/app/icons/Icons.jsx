export function IconamoonProfileFill(props) {
  return (
    <svg
...
export function MdiChevronUp(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6l-6 6z"></path>
    </svg>
  );
}

export function LineMdLoadingLoop(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function IcBaselinePlus(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function MingcuteArrowLeftLine(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function HeroiconsBars3CenterLeft16Solid(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
    ...
    >
      <path
        fillRule="evenodd"
        d="M2 3.75A.75.75 0 0 1 2.75 3h10.5a.75.75 0 0 1 0 1.5H2.75A.75.75 0 0 1 2 3.75M2 8a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 0 1.5h-4.5A.75.75 0 0 1 2 8m0 4.25a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 0 1.5H2.75a.75.75 0 0 1-.75-.75"
        clipRule="evenodd"
      ></path>
    </svg>
  );
...
export function CiArrowRightSm(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function IcomoonFreeBin(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
      ...
      {...props}
    >
      <path d="M2 5v10c0 .55.45 1 1 1h9c.55 0 1-.45 1-1V5zm3 9H4V7h1zm2 0H6V7h1zm2 0H8V7h1zm2 0h-1V7h1zm2.25-12H10V.75A.753.753 0 0 0 9.25 0h-3.5A.753.753 0 0 0 5 .75V2H1.75a.75.75 0 0 0-.75.75V4h13V2.75a.75.75 0 0 0-.75-.75M9 2H6v-.987h3z"></path>
    </svg>
  );
}

export function IcomoonFreePencil(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
      ...
      {...props}
    >
      <path d="M13.5 0a2.5 2.5 0 0 1 2 4l-1 1L11 1.5l1-1c.418-.314.937-.5 1.5-.5M1 11.5L0 16l4.5-1l9.25-9.25l-3.5-3.5zm10.181-5.819l-7 7l-.862-.862l7-7z"></path>
    </svg>
  );
}
...
export function MaterialSymbolsLightClose(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m6.4 18.308l-.708-.708l5.6-5.6l-5.6-5.6l.708-.708l5.6 5.6l5.6-5.6l.708.708l-5.6 5.6l5.6 5.6l-.708.708l-5.6-5.6z"></path>
    </svg>
  );
}

export function SolarCalendarLinear(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function UilSearch(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={20}
...
export function MdiChevronRight(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M8.59 16.58L13.17 12L8.59 7.41L10 6l6 6l-6 6z"></path>
    </svg>
  );
}
...
export function SolarPhoneOutline(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function SolarPhoneCallingOutline(props) {
  return (
...
export function IcOutlineEmail(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function BasilFacebookOutline(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function SolarStarLinear(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function IconamoonSearchThin(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="none"
...
export function CarbonLocationFilled(props) {
  return (
...
export function MaterialSymbolsMenuRounded(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function GuidanceUser1(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="none"
...
export function LetsIconsOrder(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
...
export function LineMdCloseSmall(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <g
        fill="none"
...
export function UilMapMarker(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function MdiLightInformation(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
